...
export const getItemsSoupResponse = zod.object({
  ...
  "id": zod.string().uuid(),
  "labelListVisibility": zod.enum(['labelShow', 'labelShowIfUnread', 'labelHide']),
  ...
  "metadata": zod.object({
  "calendarInvite": zod.boolean().describe('if any email contains a calendar invite'),
  "genericSender": zod.boolean().describe('if any sender is a generic email'),
  "knownSender": zod.boolean().describe('if user has previously emailed any sender'),
  "tabular": zod.boolean().describe('if any email contains a <table> html tag')
}),
