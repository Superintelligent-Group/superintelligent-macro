/**
 * Mock Entity Data for Testing EntityWithEverything Component
 *
 * This file contains comprehensive test data covering:
 * - All entity types (Document, Project, Task, Channel, Email, Search)
 * - Entities with/without versions, notifications, properties
 * - Edge cases (long names, special characters, missing fields)
 * - Search entities with highlights and content hits
 * - Shared ownership scenarios
 * - Project paths and relationships
 */
